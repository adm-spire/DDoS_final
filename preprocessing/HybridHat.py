...
class HybridHAT(AdaptiveEntropyHAT, SlidingWindowHAT_v1):
    def __init__(self, *args, **kwargs):
        super().__init__(
            grace_period=1000,       #  Increase to delay premature splits
            ...
            drift_window_threshold=800,  #  Increase for better drift detection (less aggressive pruning)
            max_size=500,            #  Reduce tree memory size for compactness
